...
const NEGOCIO = {
  nombre:       "JOPA",
  tipo:         "Cafetería",
  slogan:       "Café, postres y momentos para compartir",
  descripcion:  "Tu lugar favorito en Huimilpan para disfrutar de un buen momento. Descubre nuestros sabores y acompáñalos con la mejor repostería.",
  whatsapp:     "4421234567", // Reemplaza con el número de WhatsApp del negocio (sin espacios ni guiones)
  instagram:    "jopa.cafe",
  direccion:    "Calle Francisco I. Madero, esquina calle Belisario Domínguez con Huimilpan, Qro.",
  maps_embed:   "https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d660.7527711610695!2d-100.3493431975117!3d20.47414011478662!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses-419!2smx!4v1789969037589!5m2!1ses-419!2smx", // Embed genérico de Huimilpan, puedes actualizarlo con su pin exacto
  horarios: [
    { dia: "Viernes a Domingo" , hora: "6:00 pm – 10:30 pm" },
    //{ dia: "Sábado",          hora: "9:00 am – 10:00 pm" },
    //{ dia: "Domingo",         hora: "Cerrado" },
  ],
  servicios: [
    { nombre: "Latte",     precio: "$55",   desc: "Perfecto para los amantes del café." },
    { nombre: "Cappuccino",precio: "$55",  desc: "Una combinación perfecta de espresso, leche vaporizada y espuma." },
    { nombre: "Americano", precio: "$45",   desc: "Café filtrado con un toque de intensidad." },
    { nombre: "Cold Brew",             precio: "$50",   desc: "Café infusionado en frío, suave y refrescante." },
    { nombre: "Matcha",       precio: "$60",   desc: "Una bebida tradicional japonesa con un sabor único." },
    { nombre: "Postres",   precio: "$15-30",  desc: "Opciones deliciosas para combinar, galletas, cupcakes y pay de queso." },
  ],
};
// ============================================================
