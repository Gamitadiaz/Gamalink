...
export default function DemoSidebar({ nombreNegocio, totalClientes, vistaActual, sidebarOpen, onVistaChange, onCloseSidebar, onSignOut }: Props) {
  return (
    <aside
    ...
    >
      ...
      <nav className="flex-1 p-3 space-y-1">
        {navItems.map(item => (
          <button key={item.id} onClick={() => { onVistaChange(item.id); onCloseSidebar(); }}
