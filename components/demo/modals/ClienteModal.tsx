...
import { hoy, calcularVencimientoPorDias, formatFecha } from '@/lib/helpers';
import type { Cliente, Plan, ModalMode } from '@/lib/types';

export default function ClienteModal({ mode, cliente, planes, onClose, onSave }: {
