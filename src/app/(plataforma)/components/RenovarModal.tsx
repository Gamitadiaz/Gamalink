...
import { Cliente, Plan, METODOS_PAGO } from '@/types/demo';
import { diasRestantes, calcularVencimientoPorDias, formatMoneda, formatFecha, hoy } from '@/lib/demo-utils';
...
export default function RenovarModal({ cliente, planes, moneda, onClose, onConfirm }: Props) {
