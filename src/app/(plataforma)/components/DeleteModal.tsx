...
export default function DeleteModal({ cliente, onClose, onConfirm }: Props) {
      ...
      <div className="t-card rounded-2xl shadow-2xl w-full max-w-sm p-6" style={{ border: '1px solid var(--border)' }}>
        <div className="text-center mb-5">
          ...
          <p className="text-sm t-muted mt-1">
            ¿Eliminar a <span className="font-bold t-text">{cliente.nombre}</span>? Esta acción no se puede deshacer.
          </p>
        </div>
